  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50">
      ...
      <footer className="w-full mt-auto py-6 text-center px-4 relative z-10 bg-white/60 backdrop-blur-md border-t border-slate-100">
        <p className="typo-caption text-slate-500 flex flex-col sm:flex-row items-center justify-center gap-1.5 sm:gap-2">
            ...
            <span className="typo-label text-blue-600">กรมควบคุมโรค</span>
        </p>
      </footer>
    </div>
  );
